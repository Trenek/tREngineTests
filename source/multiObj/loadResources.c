...
static void addObjectLayout(struct EngineCore *this) {
    ...
    addResource(objectLayoutData, MULTI_OBJ_OBJECT_LAYOUT_OBJECT,
...
static void createGraphicPipelines(struct EngineCore *this) {
    ...
    addResource(graphicPipelinesData, MULTI_OBJ_GRAPHIC_PIPELINES_1, createGraphicsPipelineObj((struct GraphicsPipelineBuilder) {
