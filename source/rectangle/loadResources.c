...
static void createGraphicPipelineLayouts(struct EngineCore *this) {
    ...
    addResource(graphicPipelinesData, REC_GRAPHIC_PIPELINE_LAYOUT_1, createPipelineLayout((struct PipelineLayoutBuilder) {
...
static void createGraphicPipelines(struct EngineCore *this) {
    ...
    struct PipelineLayout *pipelineLayout = findResource(findResource(&this->resource, REC_GRAPHIC_PIPELINE_LAYOUTS), REC_GRAPHIC_PIPELINE_LAYOUT_1);
